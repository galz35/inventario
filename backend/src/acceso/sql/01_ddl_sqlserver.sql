...
-- =============================================================================
IF OBJECT_ID('dbo.Inv_seg_delegaciones', 'U') IS NOT NULL DROP TABLE dbo.Inv_seg_delegaciones;
IF OBJECT_ID('dbo.Inv_seg_permisos_empleado', 'U') IS NOT NULL DROP TABLE dbo.Inv_seg_permisos_empleado;
IF OBJECT_ID('dbo.Inv_seg_permisos_area', 'U') IS NOT NULL DROP TABLE dbo.Inv_seg_permisos_area;
...
-- =============================================================================
-- 3) Inv_seg_permisos_area
-- =============================================================================
CREATE TABLE dbo.Inv_seg_permisos_area
(
...
CREATE INDEX IX_perm_area_recibe_act ON dbo.Inv_seg_permisos_area(carnet_recibe, activo) INCLUDE (idorg_raiz, fecha_fin, alcance);
GO


-- =============================================================================
-- 4) Inv_seg_permisos_empleado
-- =============================================================================
CREATE TABLE dbo.Inv_seg_permisos_empleado
(
    id              BIGINT IDENTITY(1,1) NOT NULL,
    carnet_otorga   NVARCHAR(100) NULL,
    carnet_recibe   NVARCHAR(100) NOT NULL,
...
CREATE UNIQUE INDEX UX_perm_emp_recibe_obj_act ON dbo.Inv_seg_permisos_empleado(carnet_recibe, carnet_objetivo) WHERE activo = 1;
CREATE INDEX IX_perm_emp_recibe_act ON dbo.Inv_seg_permisos_empleado(carnet_recibe, activo) INCLUDE (carnet_objetivo, fecha_fin);
GO


-- =============================================================================
-- 5) Inv_seg_delegaciones
-- =============================================================================
CREATE TABLE dbo.Inv_seg_delegaciones
(
    id               BIGINT IDENTITY(1,1) NOT NULL,
...
CREATE UNIQUE INDEX UX_deleg_pair_act ON dbo.Inv_seg_delegaciones(carnet_delegante, carnet_delegado) WHERE activo = 1;
CREATE INDEX IX_deleg_delegado_act ON dbo.Inv_seg_delegaciones(carnet_delegado, activo) INCLUDE (carnet_delegante, fecha_fin);
GO
...
WHERE t.name IN ('p_organizacion_nodos', 'p_empleados', 'Inv_seg_permisos_area', 'Inv_seg_permisos_empleado', 'Inv_seg_delegaciones')
GROUP BY t.name
ORDER BY t.name;
