...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('InventarioCore API')
    .setDescription('API Backend para sistema InventarioCore (Fastify Powered)')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  logger.log(
    `🔍 Checking Routes: GET /api/kpis/dashboard, GET /api/equipo/hoy, GET /api/proyectos/:id/tareas`,
  );
