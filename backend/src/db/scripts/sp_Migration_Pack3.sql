...
-- =============================================
-- MIGRACIÓN InventarioCore: PAQUETE 3 (Tareas Proyecto y Multiples)
-- Fecha: 2026-01-25
-- =============================================

-- 8. SP para Obtener Tareas de un Proyecto
CREATE OR ALTER PROCEDURE [dbo].[sInv_ope_proyecto_tareas_ObtenerPorProyecto]
    @idProyecto INT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    LEFT JOIN Inv_ope_proyecto_tarea_asignados ta ON t.idTarea = ta.idTarea AND ta.tipo = 'Responsable'
    LEFT JOIN Inv_seg_usuarios u ON ta.idUsuario = u.idUsuario
...
CREATE OR ALTER PROCEDURE [dbo].[sInv_ope_proyecto_tareas_ObtenerMultiplesUsuarios]
