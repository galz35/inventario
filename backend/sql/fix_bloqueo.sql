...
/* =========================================================
   FIX BLOQUEO: sp_Bloqueo_Crear_Carnet
   Objetivo: Crear version Carnet-First y robusta para evitar errores NULL
   ========================================================= */

SET NOCOUNT ON;
GO

-- Asegurar columnas necesarias en p_Bloqueos si no existen
IF COL_LENGTH('dbo.p_Bloqueos', 'origenCarnet') IS NULL ALTER TABLE dbo.p_Bloqueos ADD origenCarnet NVARCHAR(50) NULL;
IF COL_LENGTH('dbo.p_Bloqueos', 'destinoCarnet') IS NULL ALTER TABLE dbo.p_Bloqueos ADD destinoCarnet NVARCHAR(50) NULL;
GO

CREATE OR ALTER PROCEDURE dbo.sp_Bloqueo_Crear_Carnet
(
    @idTarea          INT,
